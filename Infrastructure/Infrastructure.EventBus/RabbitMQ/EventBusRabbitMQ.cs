...
namespace Infrastructure.EventBus.RabbitMQ
{
    ...
    {
        private const string _exchangeName = "news_event_bus";
        ...
        private readonly string AUTOFAC_SCOPE_NAME = "news_event_bus";
        ...
        private void SetConsumerChannel()
        {
            ...
            _consumerChannel.ExchangeDeclare(exchange: _exchangeName, type: "direct", durable: true);
